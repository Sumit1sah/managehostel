...
class _WardenParentMessagesViewState extends State<WardenParentMessagesView> {
  ...
  void _loadParents() {
    _parents = HiveStorage.loadList(HiveStorage.appStateBox, 'parents');
            ...
            child: _filteredParents.isEmpty
                ? Center(
                    child: Text(_searchController.text.isNotEmpty
                        ? 'No parents found for Student ID "${_searchController.text}"'
                      ...
                      return Align(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            color: isWarden ? theme.colorScheme.primary : theme.colorScheme.surface,
                          ...
                          child: Column(
                            ...
                            children: [
                              Text(
                                msg['message'],
                                style: TextStyle(color: isWarden ? Colors.white : theme.colorScheme.onSurface),
                              ),
